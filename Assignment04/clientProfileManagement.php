  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST') 
  {
    ...
    if(completeProfile($fullName, $address1, $address2, $city, $state, $zip))
    {
      if(!empty($address2) && isset($address2))
      {
        ...
        $query = "INSERT INTO ClientInformation(FullName, Address1, Address2, City, State, Zipcode)
          VALUES ('$fullName', '$address1', '$address2', '$city', '$state', '$zip')";
      ...
      else
      {
        ...
        $query = "INSERT INTO ClientInformation(FullName, Address1, City, State, Zipcode)
          VALUES ('$fullName', '$address1', '$city', '$state', '$zip')";
        $result = mysqli_query($con, $query);
